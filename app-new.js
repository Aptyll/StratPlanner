...
document.addEventListener('DOMContentLoaded', function() {
    ...
    mapImage.onload = function() {
        ...
        setActiveColor(null, colorPalette.primary);
        initColorSystem();
        draw();
    };
    ...
    function drawAllDrawings() {
        // Draw each stored drawing operation
    ...
    function clearDrawing() {
        drawings.length = 0; // Clear the drawings array
    ...
    function continueDrawing(e) {
        ...
        if (currentTool === 'pen') {
            ...
            // Redraw with the temporary stroke
            draw();
            ...
            // Redraw with the temporary eraser stroke
            draw();
            ...
            // Redraw with the temporary line
            draw();
